...
declare module 'vuelidate/lib/validators' {
  ...
  /** Accepts valid email addresses. Keep in mind you still have to carefully verify it on
   * your server, as it is impossible to tell if the address is real without sending verification email. */
   ...
   * Locator might be either a sibling property name or a function,
   * that will get your component as this and nested model which sibling properties under second parameter. */
  ...
  function or(...validators: []): () => boolean
  /** Passes when all of provided validators passes. */
  function and(...validators: []): () => boolean
